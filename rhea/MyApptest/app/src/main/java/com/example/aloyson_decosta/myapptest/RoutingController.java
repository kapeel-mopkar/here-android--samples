...
import com.example.aloyson_decosta.myapptest.Routing_Navigation.Routing;
...
public class RoutingController {
    ...
    public RoutingController(Activity activity){
        m_activity=activity;
        mapFragmentView=new MapFragmentView(m_activity,"Normal");
        autoComplete();
    }
